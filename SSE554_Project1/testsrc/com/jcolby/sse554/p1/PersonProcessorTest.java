...
class PersonProcessorTest {
	...
	PersonProcessor test_processor, tmp_processor;
	...
	void setUp() throws Exception {
		test_processor = new PersonProcessor(testfile);
	}
	...
	@Test
	void canInstantiate() {
		tmp_processor = new PersonProcessor();
		assertNotNull(tmp_processor);
	}
	
	@Test
	void canInstantiateWithFileOfPeople() {
		tmp_processor = new PersonProcessor(testfile);
		assertNotNull(tmp_processor);
	}
