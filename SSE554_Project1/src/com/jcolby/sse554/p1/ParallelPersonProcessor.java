...
public class ParallelPersonProcessor {
	
	private List<Person> people_;
	
	public ParallelPersonProcessor() {
		people_ = null;
	}

	public ParallelPersonProcessor(String filename) {
	...
	public Double calculateAverage() {
		Double average_age = people_.parallelStream()
				.collect(Collectors.averagingInt(p -> p.getAge()));
		return average_age;
	}

	public long countNames() {
		long number_of_names = people_.parallelStream()
				.count();
	...
	public List<Person> sortByAge() {
		...
		List<Person> plist = people_.parallelStream()
	...
	public List<Person> sortByName() {
		...
		List<Person> sorted_list = people_.parallelStream()
